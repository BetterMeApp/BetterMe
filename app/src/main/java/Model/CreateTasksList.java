...
public class CreateTasksList {
    ...
    public static ArrayList<Task> createTaskArrayList() {
        ...
        Task complements = new Task("Give complements" ,"Give a complement to a person or people in your life.", "https://firebasestorage.googleapis.com/v0/b/betterme-cf17.appspot.com/o/default%20task%20images%2Fcomplement.jpg?alt=media&token=ff3bf693-14ec-4c3a-b0e5-44e284f00a68", null, null, 1, 0, false, 0);
